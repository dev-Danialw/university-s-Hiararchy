...
document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  $(function () {
    ...
    $(".genealogy-tree li").on("click", function (e) {
      ...
      if(modal17.classList.contains('infomodal') || modal16.classList.contains('infomodal') || modal15.classList.contains('infomodal') || modal14.classList.contains('infomodal') || modal13.classList.contains('infomodal') || modal12.classList.contains('infomodal') || modal11.classList.contains('infomodal') || modal10.classList.contains('infomodal') || modal9.classList.contains('infomodal') || modal8.classList.contains('infomodal') || modal8.classList.contains('infomodal') || modal7.classList.contains('infomodal') || modal6.classList.contains('infomodal') || modal.classList.contains('infomodal') || modal1.classList.contains('infomodal') || modal2.classList.contains('infomodal') || modal3.classList.contains('infomodal') || modal4.classList.contains('infomodal') || modal5.classList.contains('infomodal')){
        console.log('yes')
      }else if(modal17.classList.contains('hid1') || modal16.classList.contains('hid1') || modal15.classList.contains('hid1') || modal14.classList.contains('hid1') || modal13.classList.contains('hid1') || modal12.classList.contains('hid1') || modal11.classList.contains('hid1') || modal10.classList.contains('hid1') || modal9.classList.contains('hid1') || modal8.classList.contains('hid1') || modal8.classList.contains('hid1') || modal7.classList.contains('hid1') || modal6.classList.contains('hid1') || modal.classList.contains('hid1') || modal1.classList.contains('hid1') || modal2.classList.contains('hid1') || modal3.classList.contains('hid1') || modal4.classList.contains('hid1') || modal5.classList.contains('hid1')){
        console.log('clicked cross')
      }else if(modal17.classList.contains('hid2') || modal16.classList.contains('hid2') || modal15.classList.contains('hid2') || modal14.classList.contains('hid2') || modal13.classList.contains('hid2') || modal12.classList.contains('hid2') || modal11.classList.contains('hid2') || modal10.classList.contains('hid2') || modal9.classList.contains('hid2') || modal8.classList.contains('hid2') || modal8.classList.contains('hid2') || modal7.classList.contains('hid2') || modal6.classList.contains('hid2') || modal.classList.contains('hid2') || modal1.classList.contains('hid2') || modal2.classList.contains('hid2') || modal3.classList.contains('hid2') || modal4.classList.contains('hid2') || modal5.classList.contains('hid2')){
